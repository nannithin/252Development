...
const Nav = ({darkmode,toggle}) =>{
    ...
    return(
        <div className="md:sticky md:top-0 z-[100]">
            <nav className="bg-[#2f1793] flex justify-between py-5 ">
                ...
                <ul className={`md:flex md:static absolute ${!open ? `top-[-100%]` : `top-[75px]`} md:bg-transparent md:shadow-none shadow-lg md:gap-[4vw] w-full p-4 md:p-0 md:w-fit md:text-white duration-300 z-[0] ${!darkmode?'bg-white':'bg-[#181826] border-b-[1px] md:border-none border-[#333]'}`}>
