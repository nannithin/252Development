			...
			<div id='home' className="z-[-19]">
			        {
						vis && (
							<Fade bottom>
								<div className="fixed right-0 bottom-3 mx-7 my-7 z-[100] cursor-pointer bg-[#3e3cdb] rounded-full py-[8px] px-[8px]" onClick={goTop}>
				...
				<div  className="md:flex justify-between w-[90%] md:my-[200px]">
					...
					<div className="md:max-w-[600px] md:flex-row text-center md:text-xl md:mt-0 mt-[40px] md:ml-0 ml-3">
						<h1 className="font-bold md:text-4xl dark:text-[#3e3cdb] text-black text-3xl md:ml-0 ml-[20px]">
							<span className='dark:text-white text-black'>252</span> Development
						</h1>
				...
				<div  className="md:my-0 my-[70px]">
					...
					<div className="p-5 flex flex-wrap  justify-center gap-5 mx-auto my-3">
						...
						<div className="card bg-white dark:bg-[#212134] w-[250px] md:my-0 my-3 p-4 rounded-md  mx-[3vw]  light:shadow-md duration-200 ">
							<img
				...
				<div id="ourbots" className="w-full mx-auto md:my-10">
					...
					<button onClick={()=> arrowRef.current.slickPrev()} className='text-2xl py-2 px-2 bg-[#3e3cdb] text-white rounded-full hover:bg-[#2f1793] duration-200'><HiArrowSmLeft/></button>
					<button onClick={()=> arrowRef.current.slickNext()} className='text-2xl py-2 px-2 bg-[#3e3cdb] text-white rounded-full hover:bg-[#2f1793] duration-200'><HiArrowSmRight/></button>
					</div>
				</div>
